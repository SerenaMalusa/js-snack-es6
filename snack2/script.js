...
// 10. applico il metodo filter all'array che già contiene i migliori studenti
// 12. se l'id è maggiore di 120 lo trascrivo
const bestLatetsStudents = bestStudents.filter ((student) => student.id >= 120);
